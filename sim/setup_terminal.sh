...
export DV_UVME_APB_ADV_TIMER_SRC_PATH=${PROJECT_DV_DIR}/uvme_apb_adv_timer/src
export DV_UVMT_APB_ADV_TIMER_SRC_PATH=${PROJECT_DV_DIR}/uvmt_apb_adv_timer/src
