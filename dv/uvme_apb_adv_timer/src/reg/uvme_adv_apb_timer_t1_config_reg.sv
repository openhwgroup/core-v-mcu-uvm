...
`ifndef __UVME_ADV_APB_TIMER_T1_CONFIG_REG_SV__
`define __UVME_ADV_APB_TIMER_T1_CONFIG_REG_SV__


class uvme_adv_apb_timer_t1_config_reg_c extends uvml_ral_reg_c;
...
- 1'b1: The counter counts up and resets to 0 when reach threshold.
   ...
   `uvm_object_utils_begin(uvme_adv_apb_timer_t1_config_reg_c)
    ...
    * Default constructor.
    */
   extern function new(string name="uvme_adv_apb_timer_t1_config_reg", int unsigned n_bits=32, int has_coverage=UVM_NO_COVERAGE);
...
endclass : uvme_adv_apb_timer_t1_config_reg_c


function uvme_adv_apb_timer_t1_config_reg_c::new(string name="uvme_adv_apb_timer_t1_config_reg", int unsigned n_bits=32, int has_coverage=UVM_NO_COVERAGE);
...
function void uvme_adv_apb_timer_t1_config_reg_c::build();
...
`endif // __UVME_ADV_APB_TIMER_T1_CONFIG_REG_SV__
