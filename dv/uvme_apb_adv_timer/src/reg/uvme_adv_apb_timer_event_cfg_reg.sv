...
`ifndef __UVME_ADV_APB_TIMER_EVENT_CFG_REG_SV__
`define __UVME_ADV_APB_TIMER_EVENT_CFG_REG_SV__


class uvme_adv_apb_timer_event_cfg_reg_c extends uvml_ral_reg_c;
...
- 4'hF: ADV_TIMER3 channel 3.
   ...
   `uvm_object_utils_begin(uvme_adv_apb_timer_event_cfg_reg_c)
    ...
    * Default constructor.
    */
   extern function new(string name="uvme_adv_apb_timer_event_cfg_reg", int unsigned n_bits=32, int has_coverage=UVM_NO_COVERAGE);
...
endclass : uvme_adv_apb_timer_event_cfg_reg_c


function uvme_adv_apb_timer_event_cfg_reg_c::new(string name="uvme_adv_apb_timer_event_cfg_reg", int unsigned n_bits=32, int has_coverage=UVM_NO_COVERAGE);
...
function void uvme_adv_apb_timer_event_cfg_reg_c::build();
...
`endif // __UVME_ADV_APB_TIMER_EVENT_CFG_REG_SV__
