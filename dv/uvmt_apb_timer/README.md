...
## 1 - Connect the DUT to the Interfaces
 ...
 1. - [ ] DUT Wrapper - `src/tb/uvma_apb_timer_dut_wrap.sv` - Use the sample code as a guide to instantiate your DUT and connect its ports.
...
# Datum APB Timer Sub-System UVM Test Bench


# About
This IP contains the Datum APB Timer Sub-System UVM Test Bench.
